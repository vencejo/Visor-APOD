...
class APOD_scrapySpider(CrawlSpider):
    ...
    # Analiza solo los post con estructura r'^ap\d{6}'  r'/apod/ap\d+\.html'
    
    rules = (Rule(SgmlLinkExtractor(allow=[r'/apod/ap\130620\.html']),callback='analizaEntrada',follow= False) ,
    )           
