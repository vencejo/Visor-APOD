...
class APOD_scrapySpider(CrawlSpider):
    ...
    def analizaEntrada(self, response):
        ...
        #item['explicacion'] = hxs.select("//html/body/p[1]").extract()
        #item['tipo'] = hxs.select("//html/body/center/p[2]/a").extract()
        ...
        #item['ruta_local'] = "Por determinar"
        #item['dimension_x'] = hxs.select("//html/body/center/p[2]/a").extract()
        #item['dimension_y'] = hxs.select("//html/body/center/p[2]/a").extract()
        #item['peso'] = 0
        #item['favorito'] = False
